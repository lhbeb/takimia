...
function StripePaymentForm({
  ...
  return (
    <form onSubmit={handleSubmit} className={compact ? 'space-y-4' : 'space-y-5'}>
      ...
      {!isAddressVerified && (
        <div className="rounded-xl border border-[#2e3868]/15 bg-[#f0f2f9] px-4 py-3 text-sm font-medium leading-5 text-[#2e3868]">
      ...
      <button
        ...
        className={`w-full rounded-xl px-6 py-4 text-base font-bold text-white transition-colors focus:outline-none focus:ring-4 focus:ring-[#2e3868] focus:ring-offset-2 ${
