      ...
      <div className="hidden md:flex fixed left-0 right-0 top-[88px] z-50 justify-center items-start pointer-events-none">
        ...
        >
          ...
          <input
            ...
            placeholder="Search espresso machines, coffee makers, grinders..."
            className="bg-transparent outline-none border-0 flex-1 min-w-0 text-[#262626] placeholder-gray-400 text-lg"
            autoFocus={open}
            onKeyDown={handleKeyDown}
            aria-label="Search for coffee machines and espresso gear"
          />
          {query.length > 0 && (
            <ArrowRight className="h-5 w-5 text-[#2e3868] animate-bounce-x ml-1" aria-label="Press Enter to search" />
          )}
      ...
      <div className="md:hidden fixed left-4 right-4 top-4 z-50 animate-scale-fade-in">
        ...
        >
          ...
          <input
            ...
            value={query}
            onChange={(e) => setQuery(e.target.value)}
            placeholder="Search espresso machines, coffee makers..."
            className="bg-transparent outline-none border-0 flex-1 min-w-0 text-[#262626] placeholder-gray-400 text-lg"
            autoFocus={open}
            onKeyDown={handleKeyDown}
