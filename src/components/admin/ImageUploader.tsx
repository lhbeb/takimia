        ...
        <div>
          ...
          <div
            ...
            className={`
              ...
              ${
                dragActiveThumbnail
                  ? 'border-[#2e3868] bg-blue-50'
                  : 'border-[#2e3868]/30 hover:border-[#2e3868]/50'
              }
          ...
          >
            ...
            {uploading && pendingThumbnail ? (
              <div className="space-y-2">
                <Loader2 className="h-10 w-10 mx-auto text-[#2e3868] animate-spin" />
                <p className="text-sm text-gray-600">{uploadProgress}</p>
              </div>
            ) : (
              <div className="space-y-2">
                <Upload className="h-10 w-10 mx-auto text-[#2e3868]" />
                <div>
          ...
          {(thumbnail || pendingThumbnail) && (
            <div className="mt-4">
              <div className="inline-block relative group">
                <div className="relative w-32 h-32 rounded-lg overflow-hidden border-2 border-[#2e3868] bg-gray-100">
                  {pendingThumbnail ? (
                    <Image
                  ...
                  {pendingThumbnail && (
                    <div className="absolute top-1 right-1 bg-[#2e3868] text-white text-xs px-2 py-0.5 rounded">
                      Pending
                    </div>
                  )}
                  <div className="absolute bottom-1 left-1 bg-[#2e3868] text-white text-xs px-2 py-0.5 rounded font-semibold">
                    Thumbnail
                  </div>
                </div>
              </div>
