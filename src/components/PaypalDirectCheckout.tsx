...
const PaypalDirectCheckout: React.FC<PaypalDirectCheckoutProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
      {/* Backdrop */}
      <div
        className="absolute inset-0 bg-[#2e3868]/40 backdrop-blur-sm animate-in fade-in duration-300"
        ...
        <div className="p-6">
          ...
          <div className="mb-5 p-4 bg-gray-50 rounded-2xl border border-gray-100">
            <div className="flex justify-between items-start mb-1">
              ...
              <span className="font-bold text-[#2e3868] whitespace-nowrap text-base">
          ...
          <div className="mb-5 flex items-start gap-3 rounded-2xl border border-blue-100 bg-blue-50 p-4">
            <MapPin className="mt-0.5 h-4 w-4 shrink-0 text-[#2e3868]" aria-hidden="true" />
            <div className="min-w-0">
              <p className="mb-1 text-xs font-semibold uppercase text-[#2e3868]">Delivery address</p>
