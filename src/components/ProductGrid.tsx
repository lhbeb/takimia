              ...
              <div className="grid gap-4 px-6 py-6 md:grid-cols-[repeat(auto-fit,minmax(240px,1fr))]">
                    ...
                    <div className="mt-4 flex gap-3">
                      <div className="w-full">
                        ...
                        <input
                          ...
                          placeholder="0"
                          className="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#2e3868]"
                        />
                      </div>
                      <div className="w-full">
                        <label className="mb-1 block text-xs font-medium uppercase tracking-wide text-gray-500">
                ...
                <section className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
                  ...
                  >
                    <span>
                      Brands
                      {selectedBrands.length > 0 ? (
                        <span className="ml-1 text-[#2e3868]">({selectedBrands.length})</span>
                      ) : null}
                    </span>
                  ...
                  {expandedSections.brands ? (
                    <div className="mt-4 max-h-48 space-y-1 overflow-y-auto pr-1 text-sm scrollbar-thin scrollbar-track-transparent scrollbar-thumb-gray-300">
                      {(showAllBrands ? brandOptions : brandOptions.slice(0, 8)).map((brand) => (
                        ...
                        >
                          <input
                            ...
                            className="h-4 w-4 rounded border-gray-300 text-[#2e3868] focus:ring-[#2e3868]"
                          />
                          {brand}
                        </label>
                      ))}
                      ...
                      {brandOptions.length > 8 ? (
                        <button
                          type="button"
                          className="mt-2 text-xs font-semibold uppercase tracking-wide text-[#2e3868] hover:underline"
                ...
                <section className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
                  ...
                  >
                    <span>
                      Condition
                      {selectedConditions.length > 0 ? (
                        <span className="ml-1 text-[#2e3868]">({selectedConditions.length})</span>
                      ) : null}
                    </span>
                ...
                {activeFilters > 0 ? (
                  <div className="md:col-[1/-1]">
                    <button
                      type="button"
                      className="w-full rounded-xl border border-[#2e3868] bg-[#2e3868]/5 px-4 py-3 text-sm font-semibold text-[#2e3868] transition-colors duration-200 hover:bg-[#2e3868]/10"
          ...
          <div className="flex-grow">
              ...
              <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className={`${title ? '' : 'ml-auto'} flex items-center gap-3`}>
                  ...
                  >
                    ...
                    <span>Filters</span>
                    {activeFilters > 0 ? (
                      <span className="rounded-full bg-[#2e3868] px-2 py-0.5 text-xs font-semibold text-white">
                        {activeFilters}
                      </span>
                    ) : null}
                  </button>
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="appearance-none rounded-lg border border-gray-300 bg-white px-4 py-2 pr-8 text-sm focus:outline-none focus:ring-2 focus:ring-[#2e3868]"
                    >
            ...
            {activeFilters > 0 ? (
              <div className="mb-6 flex flex-wrap items-center gap-2">
                {priceRange.min !== "" ? (
                  <span className="inline-flex items-center gap-1.5 rounded-full bg-[#2e3868]/10 px-3 py-1.5 text-sm font-medium text-[#2e3868]">
                    Min: ${priceRange.min}
                    <button
                      type="button"
                      className="rounded-full p-0.5 hover:bg-[#2e3868]/20"
                ...
                {selectedBrands.map((brand) => (
                  <span
                    key={brand}
                    className="inline-flex items-center gap-1.5 rounded-full bg-[#2e3868]/10 px-3 py-1.5 text-sm font-medium text-[#2e3868]"
                  >
                    {brand}
                    <button
                      type="button"
                    ...
                    <div className="flex items-center gap-1 sm:gap-2">
                      ...
                      <button
                        ...
                        className={`px-3 py-2 rounded-lg transition-colors duration-300 flex items-center gap-1 ${currentPage === 1
                            ...
                            : "bg-white text-gray-700 border border-gray-300 hover:bg-[#2e3868]/10 hover:text-[#2e3868]"
                          }`}
                        ...
                        {currentPage > 3 && (
                          <>
                            <button
                              ...
                              className="px-3 sm:px-4 py-2 rounded-lg transition-colors duration-300 bg-white text-gray-700 border border-gray-300 hover:bg-[#2e3868]/10 hover:text-[#2e3868]"
                            >
                              1
                            </button>
                            {currentPage > 4 && (
                            ...
                            pages.push(
                              <button
                                ...
                                className={`px-3 sm:px-4 py-2 rounded-lg transition-colors duration-300 ${currentPage === i
                                    ? "bg-[#2e3868] text-white font-semibold"
                                    : "bg-white text-gray-700 border border-gray-300 hover:bg-[#2e3868]/10 hover:text-[#2e3868]"
                                  }`}
                              >
                                {i}
