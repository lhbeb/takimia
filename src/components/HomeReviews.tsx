          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100">
            <div className="p-8 text-center">
              ...
              <button
                ...
                className="bg-[#2e3868] hover:bg-[#1f274a] text-[#F0F6FF] px-6 py-3 rounded-lg font-medium transition-colors duration-200"
              >
                Write a Review
              </button>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100">
            ...
            <div className="border-b border-gray-200 p-6">
              <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
                {/* Rating Summary */}
                <div>
                  <h2 className="text-2xl font-bold text-[#262626] mb-1">What Takimia Customers Say</h2>
                    ...
                    <div>
                      <div className="flex">
                        {[...Array(5)].map((_, i) => (
                          <Star 
                            key={i}
                            className={`h-5 w-5 ${i < Math.floor(reviewStats.averageRating) ? 'text-[#2e3868] fill-[#2e3868]' : 'text-gray-300'}`}
                          />
                        ))}
                      </div>
                ...
                <div className="flex items-center">
                  <button
                    onClick={() => setShowReviewForm(true)}
                    className="bg-[#2e3868] hover:bg-[#1f274a] text-[#F0F6FF] px-6 py-3 rounded-lg font-medium transition-colors duration-200 flex items-center gap-2"
                  >
              ...
              {displayReviews.map((review, index) => {
                ...
                return (
                  ...
                  {review.productTitle && review.productSlug && (
                    <div className="mb-2">
                      <span className="text-xs text-[#2e3868] hover:text-[#1f274a] hover:underline cursor-default inline-flex items-center gap-1">
                        {review.productTitle}
                      </span>
                    </div>
                  )}
                  ...
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex">
                      {[...Array(5)].map((_, i) => (
                        <Star 
                          key={i}
                          className={`h-3.5 w-3.5 ${i < review.rating ? 'text-[#2e3868] fill-[#2e3868]' : 'text-gray-300'}`}
                        />
                      ))}
                    </div>
                  </div>
                    ...
                    <div className="mt-3 flex flex-wrap gap-1.5">
                      {previewImages.map((img, imgIndex) => (
                        <button
                          ...
                          className="relative w-16 h-16 rounded-md overflow-hidden bg-gray-200 group cursor-pointer hover:ring-2 ring-[#2e3868] transition-all duration-200"
                        >
                          <Image
                            src={img}
              ...
              <form onSubmit={handleSubmitReview} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2e3868] focus:border-transparent"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2e3868] focus:border-transparent resize-none"
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <label className="flex items-center justify-center gap-2 px-4 py-3 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-[#2e3868] hover:bg-[#2e3868]/10 transition-colors duration-200">
                  ...
                  <button
                    ...
                    className={`flex-1 px-4 py-2 rounded-lg font-medium transition-colors duration-200 ${
                      isSubmitting 
                        ...
                        : 'bg-[#2e3868] hover:bg-[#1f274a] text-[#F0F6FF]'
                    }`}
                  >
