...
export default function PaypalInvoiceConfirmation({
    ...
    const [payeeEmail, setPayeeEmail] = useState('heytakimia@gmail.com');
            ...
            <div className="min-h-screen bg-[#f6f7fb] py-6 sm:py-10 px-4">
                <div className="mx-auto max-w-5xl">
                    <div className="mb-5">
                        <button
                            onClick={onClose}
                            className="inline-flex items-center gap-2 text-sm font-medium text-gray-500 hover:text-[#2e3868] transition-colors"
                        >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[1.15fr_0.85fr] gap-6">
                        <div className="rounded-[28px] border border-[#e8ebf3] bg-white shadow-[0_20px_80px_rgba(46,56,104,0.08)] overflow-hidden">
                                        ...
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="mt-2 text-sm leading-7 text-emerald-900/85">
                                                    Thank you! Our Takimia payment team is verifying your PayPal transfer screenshot. <strong>Most orders are confirmed within 2–3 minutes.</strong> You will receive a confirmation email shortly.
                                                </p>
                                    ...
                                    <>
                                        <div className="grid gap-4 sm:grid-cols-2">
                                            <div className="rounded-2xl border border-[#e9edf4] bg-[#fbfcff] p-5">
                                                ...
                                                <p className="mt-2 break-all text-lg font-bold text-[#2e3868]">{payeeEmail}</p>
                                            </div>
                                            <div className="rounded-2xl border border-[#e9edf4] bg-[#fbfcff] p-5">
                                                <p className="text-[11px] font-semibold uppercase tracking-[0.22em] text-gray-500">Exact Amount</p>
                                                <p className="mt-2 text-3xl font-extrabold text-[#2e3868]">{orderTotal}</p>
                                            </div>
                                        </div>
                                            ...
                                            <div className="mt-4 space-y-4">
                                                {[
                                                    ...
                                                    <div key={index} className="flex items-start gap-3">
                                                        <div className="mt-0.5 flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full bg-[#2e3868] text-sm font-bold text-white">
                                                            {index + 1}
                                                        </div>
                                        ...
                                        <div className="mt-6 rounded-3xl border border-dashed border-[#b9c3d7] bg-white p-5 sm:p-6">
                                            <div className="flex items-start gap-3">
                                                <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-[#f5f7fb] text-[#2e3868]">
                                            ...
                                            <label className="mt-5 flex cursor-pointer flex-col items-center justify-center rounded-2xl border border-[#d8dfea] bg-[#fafbff] px-6 py-8 text-center transition-colors hover:border-[#003087]/35 hover:bg-[#f3f7ff]">
                                                ...
                                                <p className="mt-4 text-sm font-semibold text-[#2e3868]">
                        ...
                        <div className="space-y-6">
                            <div className="rounded-[28px] border border-[#e8ebf3] bg-white p-6 shadow-[0_18px_50px_rgba(46,56,104,0.05)]">
                                ...
                                {sellerName && (
                                    <div className="mt-4 rounded-2xl bg-[#f7f8fc] px-4 py-3 text-sm text-gray-600">
                                        Sold by <span className="font-bold text-[#2e3868]">{sellerName}</span>
                                    </div>
                                )}
                                <div className="mt-5 space-y-3 text-sm text-gray-600">
                                    ...
                                    <div className="flex items-center justify-between border-t border-[#edf1f6] pt-3">
                                        ...
                                        <span className="text-xl font-extrabold text-[#2e3868]">{orderTotal}</span>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="flex-shrink-0 bg-white border-b border-gray-100 shadow-sm">
                    ...
                    >
                        ...
                        <div className="text-right flex-shrink-0 flex items-center gap-2">
                            <span className="text-base font-extrabold text-[#2e3868]">{orderTotal}</span>
                            <ChevronDown
                        ...
                        <div className="px-4 pb-3 border-t border-gray-100">
                            <div className="mt-3 bg-blue-50 rounded-xl p-3 space-y-2 text-sm">
                                <div className="flex items-start gap-2">
                                    <MapPin className="h-3.5 w-3.5 text-[#2e3868] flex-shrink-0 mt-0.5" />
                                    <span className="text-gray-700 text-xs leading-snug">{address}</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <Mail className="h-3.5 w-3.5 text-[#2e3868] flex-shrink-0" />
                                    <span className="text-[#2e3868] text-xs font-medium break-all">{shippingData.email}</span>
                                </div>
                                {sellerName && (
                                    <div className="flex items-center gap-2 pt-2 mt-1 border-t border-blue-100/50">
                                        <span className="text-[#2e3868] text-xs font-medium opacity-90 text-left">Sold by: {sellerName}</span>
                                    </div>
                                )}
            ...
            <div className="hidden lg:flex min-h-screen bg-gray-50 items-start justify-center py-10 px-4">
                ...
                >
                    ...
                    <div className="w-1/2 flex-shrink-0 border-r border-gray-100 flex flex-col">
                        <div className="h-1 w-full bg-[#2e3868]" />
                        <div className="p-8 flex flex-col flex-1">
                            ...
                            {sellerName && (
                                <div className="bg-gray-50 text-[#262626] rounded-xl px-4 py-3 flex items-center justify-between mb-4 border border-gray-100">
                                    ...
                                    <span className="text-sm font-bold text-[#2e3868]">{sellerName}</span>
                                </div>
                            )}

                            <div className="bg-[#2e3868] text-white rounded-xl px-4 py-3 flex items-center justify-between mb-5">
                            ...
                            <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 space-y-3 text-sm mb-5">
                                <p className="text-xs font-semibold text-[#2e3868] uppercase tracking-wide mb-1">Delivery Details</p>
                                <div className="flex items-start gap-2">
                                    <MapPin className="h-4 w-4 text-[#2e3868] flex-shrink-0 mt-0.5" />
                                    <span className="text-gray-700 leading-snug">{address}</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <Mail className="h-4 w-4 text-[#2e3868] flex-shrink-0" />
                                    <span className="text-[#2e3868] font-medium break-all">{shippingData.email}</span>
                                </div>
                            ...
                            <div className="mt-auto flex flex-col gap-2 pt-4 border-t border-gray-100 mb-5">
                                <div className="flex items-center gap-2 text-xs text-gray-400">
                                    <ShieldCheck className="h-3.5 w-3.5 text-[#2e3868]" />
                                    <span>Secured with SSL encryption</span>
                                </div>
                                <div className="flex items-center gap-2 text-xs text-gray-400">
                                    <Clock className="h-3.5 w-3.5 text-[#2e3868]" />
                            ...
                            <p className="mt-3 text-center text-xs text-gray-400">
                                Questions?{' '}
                                <a href="mailto:contact@takimia.com" className="text-[#2e3868] hover:underline">contact@takimia.com</a>
                            </p>
                        </div>
                    </div>
