                    ...
                    >
                        <div className="flex items-center space-x-4">
                            ...
                            <div className="flex-1 min-w-0">
                                <p className="font-bold text-[#2e3868] text-base mb-0.5">Address Confirmed</p>
                                ...
                                <div className="mt-4 p-4 bg-blue-50 rounded-xl border border-blue-100">
                                    <div className="flex items-start justify-between gap-2">
                                        <div className="flex items-start space-x-3 flex-1 min-w-0">
                                            <MapPin className="h-4 w-4 shrink-0 text-[#2e3868] mt-0.5" />
                                        ...
                                        <button
                                            ...
                                            className="flex-shrink-0 p-1.5 rounded-lg text-gray-400 hover:text-[#2e3868] hover:bg-blue-100 transition-colors duration-150"
                    ...
                    >
                        {isLoading && (
                            <div className="pointer-events-none absolute inset-0 z-10 flex flex-col items-center justify-center bg-white rounded-2xl">
                                <div className="w-12 h-12 border-4 border-[#2e3868]/30 border-t-[#2e3868] rounded-full animate-spin mb-4" />
                    ...
                    <div className="mt-8 mb-8 sm:mt-10 flex flex-row flex-wrap items-center justify-center gap-3 sm:gap-4 text-xs sm:text-sm text-gray-600">
                        <div className="flex items-center gap-1.5 sm:gap-2">
                            <span className="inline-flex items-center justify-center bg-gray-100 rounded-full p-1">
                                <svg className="h-3 w-3 sm:h-4 sm:w-4 text-[#2e3868]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                        ...
                        <div className="flex items-center gap-1.5 sm:gap-2">
                            <span className="inline-flex items-center justify-center bg-gray-100 rounded-full p-1">
                                <Check className="h-3 w-3 sm:h-4 sm:w-4 text-[#2e3868]" />
                            </span>
