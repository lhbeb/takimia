      ...
      <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            type="button"
            onClick={addReview}
            className="inline-flex items-center gap-1.5 px-3.5 py-2 bg-[#2e3868] text-white text-xs font-medium rounded-xl hover:bg-[#1f274a] transition-all shadow-sm"
          >
                  ...
                  <div className="px-5 pb-5 pt-1 space-y-4 bg-[#fafafa] border-t border-gray-100">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-3">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 border border-gray-200 rounded-xl bg-white focus:ring-2 focus:ring-[#2e3868] focus:border-[#2e3868] outline-none transition-all text-sm"
                        />
                      </div>
                      <div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full px-3 py-2 border border-gray-200 rounded-xl bg-white focus:ring-2 focus:ring-[#2e3868] focus:border-[#2e3868] outline-none transition-all text-sm resize-y"
                      />
                    </div>
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <button
                          ...
                          className="inline-flex items-center gap-1 text-xs font-medium text-[#2e3868] hover:text-[#1f274a] transition-colors"
                        >
                          <Plus className="h-3.5 w-3.5" />
                          Add Image
                        </button>
                                ...
                                <label
                                  className={`relative flex-shrink-0 inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-xs font-medium cursor-pointer transition-colors ${
                                    isUploading
                                      ...
                                      : 'bg-[#2e3868]/8 text-[#2e3868] hover:bg-[#2e3868]/15'
                                  }`}
                                >
