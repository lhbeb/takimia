...
const CheckoutPage: React.FC = () => {
  ...
  // Phase 1: initialize PaymentIntent on mount for stripe flow
  useEffect(() => {
  ...
  // Reset address verification whenever any address field changes
    ...
    try {
      ...
      const requestBody = {
        ...
        product: {
          ...
          // Preserve Shopify variant metadata for server-side checkout-link resolution.
          meta: product.meta || {},
  ...
  const handleContinueToCheckout = async (event: FormEvent) => {
    ...
    try {
      ...
      if (checkoutFlow === 'kofi') {
        ...
        // Phase 2: link the PaymentIntent to the verified order + shipping
