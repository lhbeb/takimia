...
export default function ContactPage() {
  ...
  const schemaMarkup = {
    ...
    '@graph': [
      {
        '@type': 'ContactPage',
        '@id': 'https://takimia.com/contact#webpage',
        'url': 'https://takimia.com/contact',
        'name': 'Contact Us | Takimia',
        'description':
          'Contact Takimia customer support team. Reach us by phone, email, or send us a direct message.',
        'mainEntity': {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2e3868] focus:border-transparent"
                        disabled={isSending}
                      />
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        required
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2e3868] focus:border-transparent bg-white"
                        disabled={isSending}
                      >
                        <option value="">Select a reason</option>
                        <option value="selling">Selling on Takimia</option>
                    ...
                    <button
                      type="submit"
                      className={`w-full bg-[#2e3868] hover:bg-[#1f274a] text-white font-medium py-3 rounded-lg transition-colors duration-300 ${isSending ? 'opacity-60 cursor-not-allowed' : ''}`}
                      disabled={isSending}
                    >
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start">
                      <Mail className="h-6 w-6 text-[#2e3868] mt-1 shrink-0" />
                      <div className="ml-4">
