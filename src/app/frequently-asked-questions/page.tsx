...
export const metadata: Metadata = {
  ...
  description:
    'Find answers about Takimia coffee machines, espresso makers, ordering, shipping, returns, tracking, local pickup, and customer support.',
  alternates: {
    canonical: 'https://takimia.com/frequently-asked-questions',
  },
};
  ...
  return (
    <main className="min-h-screen bg-[#f3f4f6]">
      ...
      <section className="bg-[#2e3868] px-4 py-14 text-[#F0F6FF] sm:py-20">
        <div className="container mx-auto max-w-4xl">
          ...
          <p className="mt-5 max-w-2xl text-base leading-7 text-[#F0F6FF]/75 sm:text-lg">
            Straightforward answers about shopping, delivery, returns, pickup, and support at Takimia.
          </p>
        </div>
      </section>
      ...
      <section className="px-4 py-12 sm:py-16" aria-label="Frequently asked questions">
        <div className="container mx-auto max-w-4xl">
          <div className="divide-y divide-[#2e3868]/10 border-y border-[#2e3868]/10 bg-white px-5 sm:px-8">
            {STORE_FAQS.map((faq) => (
          ...
          <div className="mt-10 flex flex-col items-start justify-between gap-5 rounded-2xl bg-[#2e3868] p-6 text-[#F0F6FF] sm:flex-row sm:items-center sm:p-8">
            <div>
