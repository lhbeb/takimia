    ...
    >
      ...
      <div className="mb-4 flex justify-end">
        <button
          ...
          className="inline-flex items-center gap-2 px-4 py-2 bg-[#2e3868] text-white rounded-lg hover:bg-[#1f274a] transition-colors"
        >
          ...
          <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-6">
            ...
            <div className="space-y-3 mb-6">
              ...
              <button
                ...
                className="w-full text-left p-4 border-2 border-[#2e3868]/20 bg-[#2e3868]/5 rounded-xl hover:bg-[#2e3868]/10 hover:border-[#2e3868]/30 transition-colors"
              >
                <div className="flex items-center justify-between">
                  <div>
                  ...
                  <Package className="h-6 w-6 text-[#2e3868] flex-shrink-0" />
                </div>
              </button>
            </div>
        ...
        <div className="space-y-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-10 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#2e3868] focus:border-[#2e3868] outline-none"
            />
            {searchQuery && (
              <button
          ...
          <div className="flex items-center gap-4 flex-wrap">
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#2e3868] focus:border-[#2e3868] outline-none bg-white"
              >
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 px-4 py-3 mb-4 flex items-center justify-between flex-wrap gap-3">
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="text-xs text-[#2e3868] hover:underline font-medium"
            >
              ...
              >
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    {/* Customer Avatar */}
                    <div className="h-10 w-10 bg-gradient-to-br from-[#2e3868] to-purple-600 rounded-full flex items-center justify-center text-white font-semibold text-sm flex-shrink-0">
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center gap-2">
                          ...
                          <Link
                            ...
                            rel="noopener noreferrer"
                            onClick={(e) => e.stopPropagation()}
                            className="inline-flex items-center gap-1 px-2 py-1 text-xs font-medium text-[#2e3868] hover:text-[#1f274a] hover:bg-[#2e3868]/5 rounded-lg transition-colors"
                            title="View product"
                          >
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-100 flex flex-wrap gap-2">
                    ...
                    {!order.email_sent && (
                      <button
                        ...
                        className="inline-flex items-center gap-2 px-3 py-2 bg-[#2e3868]/10 text-[#2e3868] rounded-lg text-sm font-medium hover:bg-[#2e3868]/15 disabled:opacity-50 transition-all"
                      >
