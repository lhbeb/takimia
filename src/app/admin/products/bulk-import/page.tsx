  ...
  return (
    <AdminLayout title="Bulk Import" subtitle="Import multiple products from ZIP file">
      <div className="max-w-4xl mx-auto">
        ...
        {uploadProgress && (
          <div className="mb-6 p-4 bg-[#2e3868]/5 border border-[#2e3868]/20 rounded-lg">
            <div className="flex items-center gap-3">
              <Loader2 className="h-5 w-5 text-[#2e3868] animate-spin flex-shrink-0" />
              <div className="flex-1">
                <div className="text-sm font-semibold text-[#1f274a]">Processing...</div>
                <div className="text-sm text-[#1f274a]">{uploadProgress}</div>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          ...
          <div className="space-y-3 text-sm text-gray-700">
            <div className="flex items-start gap-2">
              <span className="font-semibold text-[#2e3868]">1.</span>
              <div>
            ...
            <div className="flex items-start gap-2">
              <span className="font-semibold text-[#2e3868]">2.</span>
              <div>
          ...
          >
            ...
            {uploading ? (
              <div className="space-y-4">
                <Loader2 className="h-12 w-12 mx-auto text-[#2e3868] animate-spin" />
                <div>
              ...
              <div className="space-y-4">
                ...
                <div className="mt-4">
                  <button
                    type="button"
                    className="inline-flex items-center gap-2 px-6 py-2 bg-[#2e3868] text-white rounded-lg hover:bg-[#003494] transition-colors"
                  >
        ...
        <div className="mt-6 flex gap-4">
          ...
          {importResult && (
            <button
              ...
              className="px-6 py-2 bg-[#2e3868] text-white rounded-lg hover:bg-[#003494] transition-colors"
            >
              Import Another ZIP
            </button>
          )}
