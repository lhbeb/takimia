          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="mb-4 flex items-center justify-between">
              ...
              <div className="flex gap-2">
                ...
                <label className="px-4 py-2 text-sm bg-[#2e3868] text-white rounded-lg hover:bg-[#003494] cursor-pointer flex items-center gap-2">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  rows={20}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-[#2e3868] focus:border-[#2e3868] font-mono text-sm"
                  placeholder='{\n  "slug": "product-slug",\n  "title": "Product Title",\n  "description": "...",\n  "price": 99.99,\n  ...\n}'
                />
              </div>

              <div className="bg-[#2e3868]/5 border border-[#2e3868]/20 rounded-lg p-4">
                <div className="text-sm text-[#1f274a]">
                  <div className="font-semibold mb-2">Required Fields:</div>
                  <ul className="list-disc list-inside space-y-1 text-[#1f274a]">
                  ...
                  <div className="mt-3 text-[#2e3868]">
              ...
              <div className="flex gap-4">
                <button
                  ...
                  className="flex items-center gap-2 px-6 py-2 bg-[#2e3868] text-white rounded-lg hover:bg-[#003494] disabled:opacity-50 disabled:cursor-not-allowed"
                >
