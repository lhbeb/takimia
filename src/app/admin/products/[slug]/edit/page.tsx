...
type CheckoutFlow = 'buymeacoffee' | 'kofi' | 'external' | 'stripe' | 'stripe-hosted' | 'shopify' | 'paypal-invoice' | 'paypal-unclaimed' | 'paypal-direct' | 'paypal-api' | 'lemon-squeezy';
    ...
    return (
      <AdminLayout title="Not Found">
        <div className="text-center py-16">
          ...
          <Link href="/admin/products" className="text-[#2e3868] hover:underline">← Back to products</Link>
        </div>
      </AdminLayout>
    );
  }
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              disabled={saving}
              className="inline-flex items-center gap-2 px-4 py-2 bg-[#2e3868] text-white text-sm font-medium rounded-xl hover:bg-[#1f274a] disabled:opacity-50 shadow-sm"
            >
