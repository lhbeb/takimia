                        ...
                        <form onSubmit={handleSave} className="p-6 space-y-5">
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full sm:w-1/2 px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#2e3868] focus:border-transparent text-sm"
                                >
                            ...
                            <div className="pt-2">
                                ...
                                <input
                                    ...
                                    placeholder="pk_..."
                                    className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#2e3868] focus:border-transparent text-sm font-mono"
                                    required
                                />
                            ...
                            <div className="pt-2">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        placeholder="sk_..."
                                        className="w-full px-4 py-2.5 pr-12 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#2e3868] focus:border-transparent text-sm font-mono"
                                        required
                                    />
                                    <button
                                        type="button"
                            ...
                            <div className="pt-6 border-t border-gray-100 flex justify-end">
                                <button
                                    type="submit"
                                    disabled={isSaving}
                                    className="inline-flex items-center gap-2 px-6 py-2.5 bg-[#2e3868] text-white rounded-xl hover:bg-[#1f274a] transition-colors text-sm font-medium shadow-lg shadow-[#2e3868]/25 disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    {isSaving ? (
                                        <>
                        ...
                        <form onSubmit={handleSavePaypal} className="p-6 space-y-6">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#2e3868] focus:border-transparent text-sm"
                                    required
                                />
