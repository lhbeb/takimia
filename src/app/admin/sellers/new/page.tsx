        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              disabled={saving}
              className="inline-flex items-center gap-2 px-5 py-2 bg-[#2e3868] text-white text-sm font-medium rounded-xl hover:bg-[#1f274a] disabled:opacity-50 shadow-sm transition-all"
            >
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
            <div className="w-8 h-8 rounded-xl bg-[#2e3868]/8 flex items-center justify-center">
              <User className="h-4 w-4 text-[#2e3868]" />
            </div>
            <div>
            ...
            <div className="flex items-start gap-5">
              ...
              <div className="flex-shrink-0">
                <div className="relative group w-20 h-20">
                  <div className="w-20 h-20 rounded-2xl overflow-hidden bg-gradient-to-br from-[#2e3868]/10 to-[#2e3868]/5 border-2 border-gray-200 flex items-center justify-center">
                    {formData.avatar_url ? (
                      ...
                      <span className="text-2xl font-bold text-[#2e3868]/30">{avatarInitials}</span>
                    )}
                  </div>
                  {uploadingAvatar && (
                    <div className="absolute inset-0 bg-white/80 flex items-center justify-center rounded-2xl">
                      <Loader2 className="h-5 w-5 animate-spin text-[#2e3868]" />
                    </div>
                  )}
                  {/* Hover overlay */}
              ...
              <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4">
                <FormField label="Full Name" required>
                  <input
                    ...
                    className="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#2e3868] focus:border-[#2e3868] outline-none transition-all text-sm"
                  />
                </FormField>
                <FormField
                  label="Username"
                ...
                >
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-9 pr-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#2e3868] focus:border-[#2e3868] outline-none transition-all text-sm"
                    />
                  </div>
                </FormField>
              </div>
            ...
            <FormField label="Bio">
              <div className="relative">
                ...
                <textarea
                  ...
                  className="w-full pl-9 pr-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#2e3868] focus:border-[#2e3868] outline-none transition-all text-sm resize-y"
                />
              </div>
            </FormField>
          </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
            <div className="w-8 h-8 rounded-xl bg-[#2e3868]/8 flex items-center justify-center">
              <Globe className="h-4 w-4 text-[#2e3868]" />
            </div>
            <div>
        ...
        <div className="flex justify-end pb-8">
          <button
            type="submit"
            disabled={saving}
            className="inline-flex items-center gap-2 px-6 py-3 bg-[#2e3868] text-white font-medium rounded-xl hover:bg-[#1f274a] disabled:opacity-50 shadow-sm transition-all"
          >
            {saving ? <Loader2 className="h-4 w-4 animate-spin" /> : <Save className="h-4 w-4" />}
            {saving ? 'Creating…' : 'Create Seller'}
          </button>
