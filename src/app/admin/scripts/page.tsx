...
const SCRIPTS: ScriptCard[] = [
    ...
    },
    {
        ...
        description:
            ...
            'Enter the seller\'s username (e.g. official-takimia) or their database ID. ' +
    ...
    return (
        <div className={`bg-white rounded-2xl shadow-sm border overflow-hidden transition-all ${script.danger ? 'border-red-200' : 'border-gray-100'
                            ...
                            <div key={key}>
                                ...
                                {options ? (
                                    <select
                                        ...
                                        className="w-full px-3 py-2 text-sm bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2e3868] focus:border-transparent disabled:opacity-60"
                                    >
                                        {options.map(opt => {
            ...
            <div className="px-6 py-4 bg-gray-50/50 flex flex-wrap items-center gap-3">
                ...
                {state === 'preview_ready' && (
                    <>
                        ...
                        <button
                            ...
                            className="inline-flex items-center gap-2 px-4 py-2 bg-[#2e3868] text-white rounded-xl hover:bg-[#1f274a] transition-colors text-sm font-medium shadow-lg shadow-[#2e3868]/25 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                ...
                {/* Running spinner */}
                {state === 'running' && (
                    <button disabled className="inline-flex items-center gap-2 px-4 py-2 bg-[#2e3868] text-white rounded-xl text-sm font-medium opacity-75">
                        <RefreshCw className="h-4 w-4 animate-spin" />
                        Running...
                    </button>
                )}
                                    ...
                                    {response.results.map((row) => (
                                        <tr key={row.slug} className="hover:bg-gray-50/50">
                                            ...
                                            <>
                                                ...
                                                <td className="px-4 py-3">
                                                    <span className="inline-block px-2 py-0.5 bg-[#2e3868]/10 text-[#2e3868] rounded text-xs font-mono">
                                                        {row.newSellerId}
                                                    </span>
                                                </td>
                                            </>
                                                ...
                                                <>
                                                    ...
                                                    <td className="px-4 py-3">
                                                        <span className="inline-block px-2 py-0.5 bg-[#2e3868]/10 text-[#2e3868] rounded text-xs font-mono">{row.newFlow}</span>
                                                    </td>
                                                </>
                                            ) : (
                                                <>
                                                    ...
                                                    <td className="px-4 py-3 text-[#2e3868] font-mono text-xs max-w-[200px] truncate" title={row.newLink}>
                                                        {row.newLink}
                                                    </td>
                                                </>
                                            )}
