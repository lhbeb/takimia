...
export const metadata: Metadata = {
  title: 'Return & Exchange Policy | Takimia',
  description:
    'Takimia Return & Exchange Policy. We accept returns for both defective and non-defective products within 30 days. Free return label included, no restocking fee, 5-day refund processing.',
};
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50 py-12">
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        {/* Page Header */}
        <div className="mb-10">
          <h1 className="text-3xl sm:text-4xl font-extrabold text-[#2e3868] tracking-tight">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 sm:p-8 mb-10">
          <h2 className="text-lg font-bold text-[#2e3868] mb-5">Quick Overview</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            <div className="flex items-start gap-3 p-3.5 rounded-xl bg-gray-50 border border-gray-100">
              <RotateCcw className="w-5 h-5 text-[#2e3868] flex-shrink-0 mt-0.5" />
              <div>
            ...
            <div className="flex items-start gap-3 p-3.5 rounded-xl bg-gray-50 border border-gray-100">
              <RefreshCw className="w-5 h-5 text-[#2e3868] flex-shrink-0 mt-0.5" />
              <div>
            ...
            <div className="flex items-start gap-3 p-3.5 rounded-xl bg-gray-50 border border-gray-100">
              <Clock className="w-5 h-5 text-[#2e3868] flex-shrink-0 mt-0.5" />
              <div>
            ...
            <div className="flex items-start gap-3 p-3.5 rounded-xl bg-gray-50 border border-gray-100">
              <Inbox className="w-5 h-5 text-[#2e3868] flex-shrink-0 mt-0.5" />
              <div>
            ...
            <div className="flex items-start gap-3 p-3.5 rounded-xl bg-gray-50 border border-gray-100">
              <CreditCard className="w-5 h-5 text-[#2e3868] flex-shrink-0 mt-0.5" />
              <div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 sm:p-10 space-y-10 text-gray-700">
          ...
          <p className="text-lg leading-relaxed text-gray-800">
            At <strong className="text-[#2e3868]">Takimia</strong>, your satisfaction is our top priority. We want you to shop with complete confidence. If your purchase isn&apos;t right for any reason, we&apos;re here to make it simple.
          </p>

          {/* 1. Returns */}
          <div className="space-y-4 pt-4 border-t border-gray-100">
            <div className="flex items-center gap-3">
              <RotateCcw className="w-6 h-6 text-[#2e3868]" />
              <h2 className="text-2xl font-bold text-[#2e3868]">1. Returns</h2>
            </div>
          ...
          <div className="space-y-4 pt-4 border-t border-gray-100">
            <div className="flex items-center gap-3">
              <RefreshCw className="w-6 h-6 text-[#2e3868]" />
              <h2 className="text-2xl font-bold text-[#2e3868]">2. Exchanges</h2>
            </div>
          ...
          <div className="space-y-4 pt-4 border-t border-gray-100">
            <div className="flex items-center gap-3">
              <Clock className="w-6 h-6 text-[#2e3868]" />
              <h2 className="text-2xl font-bold text-[#2e3868]">3. 30-Day Return Window</h2>
            </div>
          ...
          <div className="space-y-4 pt-4 border-t border-gray-100">
            <div className="flex items-center gap-3">
              <PackageCheck className="w-6 h-6 text-[#2e3868]" />
              <h2 className="text-2xl font-bold text-[#2e3868]">4. How to Return</h2>
            </div>
          ...
          <div className="space-y-4 pt-4 border-t border-gray-100">
            <div className="flex items-center gap-3">
              <Banknote className="w-6 h-6 text-[#2e3868]" />
              <h2 className="text-2xl font-bold text-[#2e3868]">5. No Restocking Fee</h2>
            </div>
          ...
          <div className="space-y-4 pt-4 border-t border-gray-100">
            <div className="flex items-center gap-3">
              <CreditCard className="w-6 h-6 text-[#2e3868]" />
              <h2 className="text-2xl font-bold text-[#2e3868]">6. Refund Processing</h2>
            </div>
          ...
          <div className="space-y-4 pt-4 border-t border-gray-100">
            <div className="flex items-center gap-3">
              <HelpCircle className="w-6 h-6 text-[#2e3868]" />
              <h2 className="text-2xl font-bold text-[#2e3868]">8. Need Help?</h2>
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-6 border border-gray-200 grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-3">
                <div className="flex items-center gap-2 font-bold text-[#2e3868]">
                  <Phone className="w-5 h-5 text-[#2e3868]" />
                  <span>Phone</span>
                </div>
                ...
                <div className="flex items-center gap-2 font-bold text-[#2e3868] pt-2">
                  <Mail className="w-5 h-5 text-[#2e3868]" />
                  <span>Email</span>
                </div>
                <div className="text-sm text-gray-600 pl-7">
                  <a href="mailto:contact@takimia.com" className="text-blue-600 hover:underline font-semibold">contact@takimia.com</a>
                </div>
              </div>
          ...
          {/* Promise Footer */}
          <div className="bg-gradient-to-r from-[#2e3868] to-[#1f274a] text-white p-6 sm:p-8 rounded-xl shadow-md mt-8">
            ...
            <div className="mt-4 pt-4 border-t border-white/10 flex flex-wrap items-center justify-between gap-4">
              ...
              <Link
                href="/contact"
                className="inline-flex items-center px-4 py-2 rounded-lg bg-white text-[#2e3868] font-bold text-sm hover:bg-gray-100 transition-colors"
              >
                Contact Us
              </Link>
            </div>
