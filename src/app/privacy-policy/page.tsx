...
const PrivacyPolicyPage = () => (
  <div className="min-h-screen flex flex-col bg-gray-50 py-12">
    <LegalPageSchema
      name="Privacy Policy | Takimia"
      description="Takimia privacy policy explaining how customer information is collected, used, protected, and managed."
      path="/privacy-policy"
    />
    <div className="container mx-auto px-4 max-w-4xl">
      ...
      <div className="prose max-w-none text-gray-700 space-y-8">
        ...
        <p className="text-lg leading-relaxed">
          At Takimia, your privacy is important to us. This Privacy Policy explains what information we collect, how we use it, how we protect it, and the choices you have regarding your personal data when you visit or use our website.
        </p>
