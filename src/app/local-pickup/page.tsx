        ...
        <div className="overflow-hidden rounded-[32px] border border-[#D6E3FF] bg-white shadow-[0_24px_80px_rgba(0,48,153,0.10)]">
          <section className="bg-gradient-to-br from-[#2e3868] via-[#2e3868] to-[#2e3868] px-6 py-10 text-[#F0F6FF] sm:px-10 sm:py-12">
            ...
            <h1 className="mt-5 text-3xl font-bold tracking-tight sm:text-4xl">
              Pick up your Takimia order with confidence
            </h1>
            <p className="mt-4 max-w-3xl text-sm leading-7 text-[#D9E6FF] sm:text-base">
              Eligible coffee machines, espresso makers, and barista accessories can be collected from our location in Delaware, Ohio. This page covers what to expect, what to bring, and how collection works once your order is ready.
            </p>
          </section>
                    ...
                    return (
                      <div key={step.title} className="rounded-[20px] border border-[#E8EEF8] bg-[#F8FBFF] p-5">
                        <div className="flex items-start gap-4">
                          <div className="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-2xl bg-[#EEF4FF] text-[#2e3868]">
              ...
              <section className="rounded-[24px] border border-[#DCE5F5] bg-white p-6 sm:p-7">
                ...
                <div className="mt-5 flex flex-col gap-3 sm:flex-row">
                  <a
                    ...
                    className="inline-flex items-center justify-center rounded-2xl bg-[#2e3868] px-5 py-3 text-sm font-semibold text-[#F0F6FF] transition hover:bg-[#1f274a]"
                  >
                    Email Support
                  </a>
                  <Link
                    href="/contact"
                    className="inline-flex items-center justify-center rounded-2xl border border-[#2e3868]/20 bg-white px-5 py-3 text-sm font-semibold text-[#2e3868] transition hover:bg-[#EEF4FF]"
                  >
                    Contact Page
                  </Link>
                </div>
