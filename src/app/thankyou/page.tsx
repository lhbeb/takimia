      ...
      <div className="max-w-2xl w-full">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 md:p-12 text-center">
          ...
          <div className="bg-blue-50 rounded-xl p-6 mb-8">
            ...
            <div className="space-y-1 text-sm">
              <p className="text-gray-700">
                📧 <a href="mailto:contact@takimia.com" className="text-blue-600 hover:text-blue-700 font-medium">
                  contact@takimia.com
                </a>
              </p>
              <p className="text-gray-700">
                📞 <a href="tel:+17863025205" className="text-blue-600 hover:text-blue-700 font-medium">
                  +1(786) 302-5205
                </a>
              </p>
            </div>
          ...
          <div className="flex justify-center">
            <Link
              href="/"
              className="inline-flex items-center justify-center px-6 py-3 bg-[#2e3868] hover:bg-[#1f274a] text-white font-medium rounded-lg transition-colors duration-200"
            >
