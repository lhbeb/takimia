  ...
  try {
    ...
    const emailContent = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h2 style="color: #2e3868;">New Newsletter Subscription</h2>
        <p><strong>Email:</strong> ${email}</p>
        <p><strong>Date:</strong> ${new Date().toLocaleString()}</p>
        <p><strong>Source:</strong> Takimia Website Newsletter</p>
        <hr style="border: 1px solid #eee; margin: 20px 0;">
        <p style="color: #666; font-size: 14px;">
          This email was sent from the newsletter subscription form on your Takimia website.
        </p>
      </div>
    `;
    ...
    const mailOptions = {
      ...
      subject: 'New Newsletter Subscription - Takimia',
      html: emailContent,
    };
