...
function getSafeStripeError(error: any): string {
  ...
  return 'An error occurred during payment processing. Please email contact@takimia.com';
}
...
export async function POST(request: NextRequest) {
  try {
    ...
    // so do not enable shipping_address_collection here.
      ...
      line_items: [
        {
          price_data: {
            ...
            product_data: {
              ...
              description: `Takimia order ${orderReference}`,
