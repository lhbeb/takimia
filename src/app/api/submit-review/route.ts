...
export async function POST(request: NextRequest) {
  try {
    ...
    const domain = request.headers.get('origin') || request.headers.get('referer') || 'https://takimia.com';
    ...
    const emailContent = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        <h2 style="color: #2e3868; border-bottom: 2px solid #2e3868; padding-bottom: 10px;">
        ...
        <div style="background-color: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0;">
          ...
          <div style="background-color: white; padding: 15px; border-left: 4px solid #2e3868; margin: 10px 0;">
            "${content}"
          </div>
        </div>

        <div style="background-color: #e8f4fd; padding: 15px; border-radius: 8px; margin: 20px 0;">
          <h4 style="color: #2e3868; margin-top: 0;">Submission Information:</h4>
          <ul style="list-style: none; padding: 0;">
        ...
        <div style="text-align: center; margin-top: 30px; padding-top: 20px; border-top: 1px solid #ddd;">
          <p style="color: #666; font-size: 14px;">
            This review was submitted through the Takimia website review form.
          </p>
        </div>
      </div>
    `;
