...
<rss version="2.0" xmlns:g="http://base.google.com/ns/1.0">
  <channel>
    <title>Takimia Google Merchant Center Feed${targetLabel}${currencyLabel}</title>
    <link>${BASE_URL}</link>
    <description>Selected Takimia products for ${country || 'United Kingdom and United States'}${currencyLabel}</description>
    ${itemsXml}
  </channel>
</rss>`;
