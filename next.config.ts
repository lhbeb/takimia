...
const mailProjectOrigin = process.env.NEXT_PUBLIC_MAIL_PROJECT_URL
  ? new URL(process.env.NEXT_PUBLIC_MAIL_PROJECT_URL).origin
  : '';
        ...
        headers: [
          {
            ...
            value: [
              "default-src 'self'",
              `script-src 'self' 'unsafe-inline' 'unsafe-eval' https://ko-fi.com https://*.ko-fi.com https://js.stripe.com https://chatapppay-rust.vercel.app https://chatapppay.vercel.app http://code.tidio.co https://code.tidio.co http://*.tidio.co https://*.tidio.co http://*.tidiochat.com https://*.tidiochat.com https://analyticsapp-five.vercel.app ${mailProjectOrigin} https://pricemonitor-mocha.vercel.app https://www.paypal.com https://*.paypal.com https://www.17track.net https://connect.facebook.net`,
              "style-src 'self' 'unsafe-inline' https://chatapppay-rust.vercel.app https://ko-fi.com https://*.ko-fi.com https://fonts.googleapis.com http://*.tidio.co https://*.tidio.co http://*.tidiochat.com https://*.tidiochat.com",
              ...
              `frame-src 'self' https://ko-fi.com https://*.ko-fi.com https://www.youtube.com https://player.vimeo.com https://js.stripe.com https://*.stripe.com https://hooks.stripe.com https://chatapppay-rust.vercel.app https://chatapppay.vercel.app https://analyticsapp-five.vercel.app ${mailProjectOrigin} https://pricemonitor-mocha.vercel.app https://www.paypal.com https://*.paypal.com https://extcall.17track.net http://*.tidio.co https://*.tidio.co http://*.tidiochat.com https://*.tidiochat.com http://*.tidio.com https://*.tidio.com`,
              `connect-src 'self' https://ko-fi.com https://*.ko-fi.com https://vfuedgrheyncotoxseos.supabase.co https://sappffmylpsmbidysyqh.supabase.co https://*.supabase.co https://api.stripe.com https://*.stripe.com https://hooks.stripe.com https://*.stripe.network https://chatapppay-rust.vercel.app https://chatapppay.vercel.app http://*.tidio.co https://*.tidio.co http://*.tidio.com https://*.tidio.com http://*.tidiochat.com https://*.tidiochat.com wss://*.tidio.co wss://*.tidio.com wss://*.tidiochat.com https://analyticsapp-five.vercel.app https://analyticsapp.vercel.app ${mailProjectOrigin} https://pricemonitor-mocha.vercel.app https://www.paypal.com https://*.paypal.com https://extcall.17track.net https://www.facebook.com`,
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https: http:",
              "font-src 'self' data: https://fonts.gstatic.com https://ko-fi.com https://*.ko-fi.com http://code.tidio.co https://code.tidio.co http://*.tidio.co https://*.tidio.co http://*.tidiochat.com https://*.tidiochat.com",
              `frame-src 'self' https://ko-fi.com https://*.ko-fi.com https://js.stripe.com https://*.stripe.com https://hooks.stripe.com https://chatapppay-rust.vercel.app https://chatapppay.vercel.app https://analyticsapp-five.vercel.app ${mailProjectOrigin} https://pricemonitor-mocha.vercel.app https://www.paypal.com https://*.paypal.com http://*.tidio.co https://*.tidio.co http://*.tidiochat.com https://*.tidiochat.com http://*.tidio.com https://*.tidio.com`,
